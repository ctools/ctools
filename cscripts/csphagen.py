...
class csphagen(ctools.csobservation):
    ...
    def _get_parameters(self):
        ...
        if self._models.is_empty():
            ...
            spectral = gammalib.GModelSpectralPlaw(1.e-18,-2,gammalib.GEnergy(1.e6,'MeV'))
            # initialise spectral parameters to reasonable values
    ...
    def exclregmap(self, regmapobj=None):
        ...
        if regmapobj is not None:
            ...
            self._excl_reg = gammalib.GSkyRegionMap(regmapobj)
