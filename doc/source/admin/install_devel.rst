...
The current ctools development release is ``ctools-2.0.0.dev``.
...
- `Mac OS X (10.7+) <http://cta.irap.omp.eu/ctools/releases/ctools/ctools-2.0.0.dev-macosx10.7.dmg>`_
...
Note that you can choose between Python 2.7, 3.5, 3.6, 3.7 and 3.8 for your
conda environment.
