...
project = u'ctools'
copyright = u'2014-2016, ctools developers'
...
latex_documents = [
  ('contents', 'ctools.tex', u'ctools Documentation',
   u'ctools developers', 'manual'),
]
...
man_pages = [
    ('contents', 'ctools', u'ctools Documentation',
     [u'ctools developers'], 1)
]
...
texinfo_documents = [
  ('contents', 'ctools', u'ctools Documentation',
   u'ctools developers', 'ctools', 'One line description of project.',
   'Miscellaneous'),
]
