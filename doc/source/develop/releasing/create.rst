...
.. code-block:: bash
   ...
   Step 2: Current ctools version is '1.2.0.dev'. Do you want to change the package version? (y/n): y
   Current ctools version is '1.2.0.dev'. Please enter new ctools version: 1.2.0
