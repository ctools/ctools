 ...
 *
 * This is the main entry point of the ctbutterfly application. It allocates a
 * ctbutterfly object and runs the application.
 ***************************************************************************/
int main (int argc, char *argv[])
{
    ...
    ctbutterfly application(argc, argv);
