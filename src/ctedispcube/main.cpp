 ...
 *
 * This is the main entry point of the ctedispcube application. It allocates
 * a ctedispcube object and executes the application. Any exceptions that
...
int main (int argc, char *argv[])
{
    ...
    ctedispcube* application = NULL;

    // Execute application
    try {

        // Create instance of application
        application = new ctedispcube(argc, argv);
        ...
        // Report exception
        report_ctool_failure("ctedispcube", e.what());
