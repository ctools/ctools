 ...
 *
 * This is the main entry point of the ctfindvar application. It allocates a
 * ctfindvar object and executes the application. Any exceptions that occur
...
int main (int argc, char *argv[])
{
    ...
    try {
        ...
        // Report exception
        report_ctool_failure("ctfindvar", e.what());
