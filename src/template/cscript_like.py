...
# cscript_like class #
# ================== #
class cscript_like(ctools.cslikelihood):
    """
    [WHAT] script
    """
    ...
    def __getstate__(self):
        """
        Extend ctools.cslikelihood __getstate__ method
        ...
        state = {'base' : ctools.cslikelihood.__getstate__(self)}
    ...
    def __setstate__(self, state):
        """
        Extend ctools.cslikelihood __setstate__ method
        ...
        """
        # Set state
        ctools.cslikelihood.__setstate__(self, state['base'])
