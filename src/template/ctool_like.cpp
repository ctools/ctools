 ...
 ***************************************************************************/
xxx::xxx(void) : ctlikelihood(XXX_NAME, VERSION)
{
    // Initialise members
    init_members();
 ...
 ***************************************************************************/
xxx::xxx(const GObservations& obs) : ctlikelihood(XXX_NAME, VERSION, obs)
{
    // Initialise members
    init_members();
 ...
 * parameter setting.
 ***************************************************************************/
xxx::xxx(int argc, char *argv[]) : ctlikelihood(XXX_NAME, VERSION, argc, argv)
{
    // Initialise members
    init_members();
 ...
 ***************************************************************************/
xxx::xxx(const xxx& app) : ctlikelihood(app)
{
    // Initialise members
    init_members();
