...
class Test(test):
    ...
    def _test_python(self):
        ...
        # Check result
        self._check_result('comobsback_py2.xml', 'comobsback_py2', 'bgdlixA-nr3-na5-ni15-ne0')
        ...
        # Check result
        self._check_result('comobsback_py3.xml', 'comobsback_py3', 'bgdlixE-na5-ni15-ne0')
