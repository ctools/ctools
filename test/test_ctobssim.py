...
class Test(test):
    ...
    def _test_ctobssim_python(self):
        ...
        self._test_list(sim.obs()[0].events(), 250)
        ...
        self._test_list(cpy_sim.obs()[0].events(), 250)
        ...
        self._test_list(sim.obs()[0].events(), 3565)
        self._test_list(sim.obs()[1].events(), 3523)
        ...
        # Retrieve observation and check content
        self._test_list(obs[0].events(), 3565)
        self._test_list(obs[1].events(), 3523)
